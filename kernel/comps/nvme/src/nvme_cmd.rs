...
pub(crate) fn io_read(nsid: u32, lba: u64, blocks_1: u16, ptr0: u64, ptr1: u64) -> NvmeCommand {
    NvmeCommand {
        opcode: IoCommandSet::Read as u8,
        flags: 0 << IO_CMD_NOT_FUSED_BITS,
        cid: 0,
        nsid,
        _rsvd: 0,
        mptr: 0,
...
pub(crate) fn io_write(nsid: u32, lba: u64, blocks_1: u16, ptr0: u64, ptr1: u64) -> NvmeCommand {
    NvmeCommand {
